...
public class TestingSetup {
	public static void setup() {
		...
		TestingInformation ti = new TestingInformation(Account.class.toString(), mapObjectsToCallSequence, mapMethodsToSymbols, mapAttributesToSymbols, pattern, regularExpression, matcher, true);
