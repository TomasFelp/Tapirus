...
public class DummyClassTestInvaidExamples {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		
		int test = 21;//Make sure the test number corresponds to the pattern selected in TestingSetup
		
		DummyClass d1 = new DummyClass(1, 'a', true, "Homerosawa");
